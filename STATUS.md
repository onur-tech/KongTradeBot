...
## Watchdog
```
STALE — lief vor 55070s | HB: OK (334s alt)
```
...
TimeoutError
2026-05-02 10:44:42 | INFO     | polymarket_bot.fill_tracker | WS-Reconnect (TimeoutError):  — Reconnect in 30s
```
