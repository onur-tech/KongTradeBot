...
## Watchdog
```
OK — lief vor 28s | HB: WARNUNG 415s alt
```
...
2026-04-28 02:16:14 | INFO     | polymarket_bot.fill_tracker | WS-Reconnect (TimeoutError):  — Reconnect in 2s
```
