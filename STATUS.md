...
## Watchdog
```
STALE — lief vor 109243s | HB: WARNUNG 508s alt
```
...
TimeoutError
2026-05-03 01:44:41 | INFO     | polymarket_bot.fill_tracker | WS-Reconnect (TimeoutError):  — Reconnect in 30s
```
