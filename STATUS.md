...
## Watchdog
```
STALE — lief vor 3584272s | HB: WARNUNG 456s alt
```
...
TimeoutError
2026-06-12 07:02:41 | INFO     | polymarket_bot.fill_tracker | WS-Reconnect (TimeoutError):  — Reconnect in 1s
```
