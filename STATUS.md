...
## Watchdog
```
STALE — lief vor 3602503s | HB: WARNUNG 645s alt
```
...
TimeoutError
2026-06-12 12:03:23 | INFO     | polymarket_bot.fill_tracker | WS-Reconnect (TimeoutError):  — Reconnect in 30s
```
