...
## Watchdog
```
STALE — lief vor 79441s | HB: WARNUNG 563s alt
```
...
TimeoutError
2026-05-02 17:27:03 | INFO     | polymarket_bot.fill_tracker | WS-Reconnect (TimeoutError):  — Reconnect in 30s
```
