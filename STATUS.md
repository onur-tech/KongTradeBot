...
## Watchdog
```
STALE — lief vor 165656s | HB: WARNUNG 418s alt
```
...
TimeoutError
2026-05-03 17:26:24 | INFO     | polymarket_bot.fill_tracker | WS-Reconnect (TimeoutError):  — Reconnect in 30s
```
