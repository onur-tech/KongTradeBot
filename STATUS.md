...
## Watchdog
```
STALE — lief vor 157186s | HB: WARNUNG 574s alt
```
...
TimeoutError
2026-05-03 15:02:37 | INFO     | polymarket_bot.fill_tracker | WS-Reconnect (TimeoutError):  — Reconnect in 30s
```
