...
## Watchdog
```
STALE — lief vor 182876s | HB: WARNUNG 386s alt
```
...
TimeoutError
2026-05-03 22:13:56 | INFO     | polymarket_bot.fill_tracker | WS-Reconnect (TimeoutError):  — Reconnect in 30s
```
