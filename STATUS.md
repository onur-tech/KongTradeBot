...
## Watchdog
```
STALE — lief vor 198614s | HB: WARNUNG 546s alt
```
...
TimeoutError
2026-05-04 02:33:33 | INFO     | polymarket_bot.fill_tracker | WS-Reconnect (TimeoutError):  — Reconnect in 30s
```
