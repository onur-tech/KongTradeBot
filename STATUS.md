...
## Watchdog
```
OK — lief vor 30s | HB: WARNUNG 459s alt
```
...
TimeoutError
2026-04-28 21:59:18 | INFO     | polymarket_bot.fill_tracker | WS-Reconnect (TimeoutError):  — Reconnect in 1s
```
