...
## Watchdog
```
STALE — lief vor 83649s | HB: WARNUNG 478s alt
```
...
TimeoutError
2026-05-02 18:38:37 | INFO     | polymarket_bot.fill_tracker | WS-Reconnect (TimeoutError):  — Reconnect in 30s
```
