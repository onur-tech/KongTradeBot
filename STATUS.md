...
## Watchdog
```
STALE — lief vor 93596s | HB: WARNUNG 435s alt
```
...
TimeoutError
2026-05-02 21:25:07 | INFO     | polymarket_bot.fill_tracker | WS-Reconnect (TimeoutError):  — Reconnect in 30s
```
