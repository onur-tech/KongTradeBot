...
## Watchdog
```
STALE — lief vor 161417s | HB: WARNUNG 492s alt
```
...
TimeoutError
2026-05-03 16:14:31 | INFO     | polymarket_bot.fill_tracker | WS-Reconnect (TimeoutError):  — Reconnect in 30s
```
