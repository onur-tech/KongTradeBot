...
## Watchdog
```
STALE — lief vor 224018s | HB: OK (337s alt)
```
...
TimeoutError
2026-05-04 09:40:27 | INFO     | polymarket_bot.fill_tracker | WS-Reconnect (TimeoutError):  — Reconnect in 30s
```
