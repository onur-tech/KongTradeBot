...
## Watchdog
```
STALE — lief vor 219746s | HB: OK (350s alt)
```
...
TimeoutError
2026-05-04 08:29:02 | INFO     | polymarket_bot.fill_tracker | WS-Reconnect (TimeoutError):  — Reconnect in 30s
```
