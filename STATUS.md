...
## Watchdog
```
STALE — lief vor 3613078s | HB: WARNUNG 549s alt
```
...
TimeoutError
2026-06-12 15:01:14 | INFO     | polymarket_bot.fill_tracker | WS-Reconnect (TimeoutError):  — Reconnect in 30s
```
