...
## Watchdog
```
STALE — lief vor 3587320s | HB: WARNUNG 537s alt
```
...
TimeoutError
2026-06-12 07:52:08 | INFO     | polymarket_bot.fill_tracker | WS-Reconnect (TimeoutError):  — Reconnect in 4s
```
