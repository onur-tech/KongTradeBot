...
## Watchdog
```
STALE — lief vor 187118s | HB: WARNUNG 360s alt
```
...
TimeoutError
2026-05-03 23:25:04 | INFO     | polymarket_bot.fill_tracker | WS-Reconnect (TimeoutError):  — Reconnect in 30s
```
