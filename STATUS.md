...
## Watchdog
```
STALE — lief vor 141777s | HB: WARNUNG 466s alt
```
...
TimeoutError
2026-05-03 10:47:37 | INFO     | polymarket_bot.fill_tracker | WS-Reconnect (TimeoutError):  — Reconnect in 30s
```
