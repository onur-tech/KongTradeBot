...
## Watchdog
```
STALE — lief vor 225519s | HB: WARNUNG 400s alt
```
...
TimeoutError
2026-05-04 10:04:25 | INFO     | polymarket_bot.fill_tracker | WS-Reconnect (TimeoutError):  — Reconnect in 30s
```
