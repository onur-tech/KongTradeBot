...
## Watchdog
```
STALE — lief vor 10118s | HB: WARNUNG 495s alt
```
...
TimeoutError
2026-05-01 22:12:49 | INFO     | polymarket_bot.fill_tracker | WS-Reconnect (TimeoutError):  — Reconnect in 2s
```
