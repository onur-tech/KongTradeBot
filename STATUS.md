...
## Watchdog
```
STALE — lief vor 92066s | HB: OK (331s alt)
```
...
TimeoutError
2026-05-02 21:01:20 | INFO     | polymarket_bot.fill_tracker | WS-Reconnect (TimeoutError):  — Reconnect in 30s
```
