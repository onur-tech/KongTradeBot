...
## Watchdog
```
OK — lief vor 34s | HB: OK (302s alt)
```
...
## Letzte Fehler (3)
```
2026-04-27 12:48:04 | WARNING  | polymarket_bot.fill_tracker | WebSocket-Fehler: unhandled errors in a TaskGroup (1 sub-exception) — Reconnect in 30s
