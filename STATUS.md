...
## Watchdog
```
STALE — lief vor 151440s | HB: WARNUNG 573s alt
```
...
TimeoutError
2026-05-03 13:26:52 | INFO     | polymarket_bot.fill_tracker | WS-Reconnect (TimeoutError):  — Reconnect in 4s
```
