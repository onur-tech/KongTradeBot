...
def restore_positions(engine):
    ...
    try:
        ...
        # T-010: Stale-Positionen ohne token_id filtern → verhindert 400-Fehler beim Balance-Check
            ...
            async with session.get(url, timeout=aiohttp.ClientTimeout(total=15)) as resp:
                ...
                for order in orders:
                    ...
                    if order_id in engine.open_positions or order_id in engine._pending_data:
                        continue
                    # T-010: ohne token_id → skip (würde CONDITIONAL-Balance-Check mit leerem assetAddress triggern)
