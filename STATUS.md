...
## Watchdog
```
OK — lief vor 50s | HB: OK (241s alt)
```
...
TimeoutError
2026-04-29 01:03:56 | INFO     | polymarket_bot.fill_tracker | WS-Reconnect (TimeoutError):  — Reconnect in 30s
```
