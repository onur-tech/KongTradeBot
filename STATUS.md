...
## Watchdog
```
STALE — lief vor 191330s | HB: OK (322s alt)
```
...
TimeoutError
2026-05-04 00:35:54 | INFO     | polymarket_bot.fill_tracker | WS-Reconnect (TimeoutError):  — Reconnect in 30s
```
