...
## Watchdog
```
STALE — lief vor 3585793s | HB: WARNUNG 492s alt
```
...
TimeoutError
2026-06-12 07:27:27 | INFO     | polymarket_bot.fill_tracker | WS-Reconnect (TimeoutError):  — Reconnect in 2s
```
