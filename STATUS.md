...
## Watchdog
```
STALE — lief vor 11337s | HB: OK (308s alt)
```
...
TimeoutError
2026-05-01 22:36:14 | INFO     | polymarket_bot.fill_tracker | WS-Reconnect (TimeoutError):  — Reconnect in 4s
```
