...
## Watchdog
```
STALE — lief vor 145988s | HB: WARNUNG 406s alt
```
...
TimeoutError
2026-05-03 11:58:48 | INFO     | polymarket_bot.fill_tracker | WS-Reconnect (TimeoutError):  — Reconnect in 30s
```
