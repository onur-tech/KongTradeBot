...
## Watchdog
```
STALE — lief vor 33824s | HB: OK (307s alt)
```
...
TimeoutError
2026-05-02 04:51:03 | INFO     | polymarket_bot.fill_tracker | WS-Reconnect (TimeoutError):  — Reconnect in 30s
```
