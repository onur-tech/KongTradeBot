...
## Watchdog
```
STALE — lief vor 181374s | HB: OK (325s alt)
```
...
TimeoutError
2026-05-03 21:49:54 | INFO     | polymarket_bot.fill_tracker | WS-Reconnect (TimeoutError):  — Reconnect in 30s
```
