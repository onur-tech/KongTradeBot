...
## Watchdog
```
STALE — lief vor 228540s | HB: WARNUNG 553s alt
```
...
TimeoutError
2026-05-04 10:52:13 | INFO     | polymarket_bot.fill_tracker | WS-Reconnect (TimeoutError):  — Reconnect in 30s
```
