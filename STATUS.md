...
## Watchdog
```
STALE — lief vor 60786s | HB: WARNUNG 388s alt
```
...
TimeoutError
2026-05-02 12:19:03 | INFO     | polymarket_bot.fill_tracker | WS-Reconnect (TimeoutError):  — Reconnect in 30s
```
