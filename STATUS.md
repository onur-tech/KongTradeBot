...
## Watchdog
```
STALE — lief vor 100822s | HB: WARNUNG 558s alt
```
...
TimeoutError
2026-05-02 23:23:30 | INFO     | polymarket_bot.fill_tracker | WS-Reconnect (TimeoutError):  — Reconnect in 30s
```
