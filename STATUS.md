...
## Watchdog
```
OK — lief vor 52s | HB: WARNUNG 436s alt
```
...
TimeoutError
2026-04-29 01:26:56 | INFO     | polymarket_bot.fill_tracker | WS-Reconnect (TimeoutError):  — Reconnect in 30s
```
