...
## Watchdog
```
STALE — lief vor 185911s | HB: WARNUNG 573s alt
```
...
TimeoutError
2026-05-03 23:01:23 | INFO     | polymarket_bot.fill_tracker | WS-Reconnect (TimeoutError):  — Reconnect in 30s
```
