...
## Watchdog
```
STALE — lief vor 184409s | HB: WARNUNG 496s alt
```
...
TimeoutError
2026-05-03 22:37:39 | INFO     | polymarket_bot.fill_tracker | WS-Reconnect (TimeoutError):  — Reconnect in 30s
```
