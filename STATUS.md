...
## Watchdog
```
STALE — lief vor 167168s | HB: WARNUNG 490s alt
```
...
TimeoutError
2026-05-03 17:50:23 | INFO     | polymarket_bot.fill_tracker | WS-Reconnect (TimeoutError):  — Reconnect in 30s
```
