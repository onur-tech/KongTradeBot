...
## Watchdog
```
STALE — lief vor 146288s | HB: OK (57s alt)
```
...
TimeoutError
2026-05-03 12:22:37 | INFO     | polymarket_bot.fill_tracker | WS-Reconnect (TimeoutError):  — Reconnect in 30s
```
