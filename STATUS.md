...
## Watchdog
```
STALE — lief vor 174424s | HB: WARNUNG 534s alt
```
...
TimeoutError
2026-05-03 19:50:36 | INFO     | polymarket_bot.fill_tracker | WS-Reconnect (TimeoutError):  — Reconnect in 30s
```
