...
## Watchdog
```
STALE — lief vor 3604024s | HB: WARNUNG 635s alt
```
...
TimeoutError
2026-06-12 12:28:55 | INFO     | polymarket_bot.fill_tracker | WS-Reconnect (TimeoutError):  — Reconnect in 30s
```
