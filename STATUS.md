...
## Watchdog
```
STALE — lief vor 56572s | HB: WARNUNG 421s alt
```
...
TimeoutError
2026-05-02 11:08:16 | INFO     | polymarket_bot.fill_tracker | WS-Reconnect (TimeoutError):  — Reconnect in 30s
```
