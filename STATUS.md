...
## Watchdog
```
OK — lief vor 15s | HB: WARNUNG 451s alt
```
...
## Letzte Fehler (3)
```
2026-04-30 11:16:36 | WARNING  | polymarket_bot.execution | [V2] heartbeat failed: PolyApiException[status_code=400, error_message={'heartbeat_id': 'd50d2406-996e-4581-a6be-7c26d4c557d8', 'error_msg': 'Invalid Heartbeat ID'}]
[py_clob_client_v2] request error status=400 url=https://clob.polymarket.com/v1/heartbeats body={"heartbeat_id":"b843db76-cc0d-4e34-9106-48da781b6295","error_msg":"Invalid Heartbeat ID"}
2026-04-30 11:16:52 | WARNING  | polymarket_bot.execution | [V2] heartbeat failed: PolyApiException[status_code=400, error_message={'heartbeat_id': 'b843db76-cc0d-4e34-9106-48da781b6295', 'error_msg': 'Invalid Heartbeat ID'}]
```
