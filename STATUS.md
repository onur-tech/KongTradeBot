...
## Watchdog
```
STALE — lief vor 42294s | HB: OK (359s alt)
```
...
TimeoutError
2026-05-02 07:11:21 | INFO     | polymarket_bot.fill_tracker | WS-Reconnect (TimeoutError):  — Reconnect in 30s
```
