...
## Watchdog
```
STALE — lief vor 5572s | HB: OK (212s alt)
```
...
TimeoutError
2026-05-01 21:01:45 | INFO     | polymarket_bot.fill_tracker | WS-Reconnect (TimeoutError):  — Reconnect in 1s
```
