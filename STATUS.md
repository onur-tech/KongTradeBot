...
## Watchdog
```
STALE — lief vor 195576s | HB: OK (328s alt)
```
...
TimeoutError
2026-05-04 01:46:34 | INFO     | polymarket_bot.fill_tracker | WS-Reconnect (TimeoutError):  — Reconnect in 30s
```
