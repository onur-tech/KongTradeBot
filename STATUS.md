...
## Watchdog
```
OK — lief vor 1s | HB: WARNUNG 531s alt
```
...
TimeoutError
2026-04-29 02:35:59 | INFO     | polymarket_bot.fill_tracker | WS-Reconnect (TimeoutError):  — Reconnect in 30s
```
