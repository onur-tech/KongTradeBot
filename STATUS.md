...
## Watchdog
```
STALE — lief vor 90864s | HB: WARNUNG 554s alt
```
...
TimeoutError
2026-05-02 20:37:36 | INFO     | polymarket_bot.fill_tracker | WS-Reconnect (TimeoutError):  — Reconnect in 30s
```
