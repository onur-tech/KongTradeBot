...
## Watchdog
```
STALE — lief vor 97815s | HB: WARNUNG 383s alt
```
...
TimeoutError
2026-05-02 22:36:18 | INFO     | polymarket_bot.fill_tracker | WS-Reconnect (TimeoutError):  — Reconnect in 30s
```
