...
## Watchdog
```
STALE — lief vor 123383s | HB: WARNUNG 547s alt
```
...
TimeoutError
2026-05-03 05:39:43 | INFO     | polymarket_bot.fill_tracker | WS-Reconnect (TimeoutError):  — Reconnect in 30s
```
