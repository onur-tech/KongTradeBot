...
## Watchdog
```
STALE — lief vor 139039s | HB: WARNUNG 576s alt
```
...
TimeoutError
2026-05-03 10:00:09 | INFO     | polymarket_bot.fill_tracker | WS-Reconnect (TimeoutError):  — Reconnect in 30s
```
