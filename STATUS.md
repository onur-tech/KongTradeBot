...
## Watchdog
```
STALE — lief vor 194348s | HB: WARNUNG 513s alt
```
...
TimeoutError
2026-05-04 01:23:00 | INFO     | polymarket_bot.fill_tracker | WS-Reconnect (TimeoutError):  — Reconnect in 30s
```
