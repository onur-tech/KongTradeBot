...
## Watchdog
```
STALE — lief vor 3605553s | HB: WARNUNG 626s alt
```
...
TimeoutError
2026-06-12 12:54:32 | INFO     | polymarket_bot.fill_tracker | WS-Reconnect (TimeoutError):  — Reconnect in 30s
```
