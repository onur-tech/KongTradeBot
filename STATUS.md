...
## Watchdog
```
STALE — lief vor 12838s | HB: WARNUNG 404s alt
```
...
TimeoutError
2026-05-01 22:59:40 | INFO     | polymarket_bot.fill_tracker | WS-Reconnect (TimeoutError):  — Reconnect in 8s
```
