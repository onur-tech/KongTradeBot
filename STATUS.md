...
## Watchdog
```
STALE — lief vor 105335s | HB: OK (24s alt)
```
...
TimeoutError
2026-05-03 00:57:36 | INFO     | polymarket_bot.fill_tracker | WS-Reconnect (TimeoutError):  — Reconnect in 30s
```
