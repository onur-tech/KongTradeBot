...
## Watchdog
```
STALE — lief vor 59282s | HB: OK (299s alt)
```
...
TimeoutError
2026-05-02 11:55:29 | INFO     | polymarket_bot.fill_tracker | WS-Reconnect (TimeoutError):  — Reconnect in 30s
```
