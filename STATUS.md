...
## Watchdog
```
STALE — lief vor 113759s | HB: OK (55s alt)
```
...
TimeoutError
2026-05-03 03:18:29 | INFO     | polymarket_bot.fill_tracker | WS-Reconnect (TimeoutError):  — Reconnect in 30s
```
