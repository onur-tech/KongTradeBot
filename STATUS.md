...
## Watchdog
```
STALE — lief vor 3597870s | HB: WARNUNG 538s alt
```
...
TimeoutError
2026-06-12 10:47:57 | INFO     | polymarket_bot.fill_tracker | WS-Reconnect (TimeoutError):  — Reconnect in 30s
```
