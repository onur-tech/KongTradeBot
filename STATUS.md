...
## Watchdog
```
STALE — lief vor 217022s | HB: WARNUNG 485s alt
```
...
TimeoutError
2026-05-04 07:41:23 | INFO     | polymarket_bot.fill_tracker | WS-Reconnect (TimeoutError):  — Reconnect in 30s
```
