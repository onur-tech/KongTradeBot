...
## Watchdog
```
STALE — lief vor 212801s | HB: WARNUNG 562s alt
```
...
TimeoutError
2026-05-04 06:29:45 | INFO     | polymarket_bot.fill_tracker | WS-Reconnect (TimeoutError):  — Reconnect in 30s
```
