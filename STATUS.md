...
## Watchdog
```
STALE — lief vor 199815s | HB: OK (338s alt)
```
...
TimeoutError
2026-05-04 02:57:03 | INFO     | polymarket_bot.fill_tracker | WS-Reconnect (TimeoutError):  — Reconnect in 30s
```
