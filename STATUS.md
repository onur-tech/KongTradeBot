...
## Watchdog
```
STALE — lief vor 14341s | HB: WARNUNG 499s alt
```
...
TimeoutError
2026-05-01 23:23:07 | INFO     | polymarket_bot.fill_tracker | WS-Reconnect (TimeoutError):  — Reconnect in 16s
```
