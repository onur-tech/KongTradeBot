...
## Watchdog
```
STALE — lief vor 107741s | HB: WARNUNG 420s alt
```
...
TimeoutError
2026-05-03 01:21:06 | INFO     | polymarket_bot.fill_tracker | WS-Reconnect (TimeoutError):  — Reconnect in 30s
```
