...
## Watchdog
```
STALE — lief vor 158390s | HB: OK (344s alt)
```
...
TimeoutError
2026-05-03 15:26:31 | INFO     | polymarket_bot.fill_tracker | WS-Reconnect (TimeoutError):  — Reconnect in 30s
```
