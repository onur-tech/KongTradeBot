...
## Watchdog
```
OK — lief vor 14s | HB: WARNUNG 523s alt
```
...
TimeoutError
2026-04-28 23:08:40 | INFO     | polymarket_bot.fill_tracker | WS-Reconnect (TimeoutError):  — Reconnect in 8s
```
