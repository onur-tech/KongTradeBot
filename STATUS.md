...
## Watchdog
```
STALE — lief vor 148417s | HB: WARNUNG 411s alt
```
...
TimeoutError
2026-05-03 12:39:11 | INFO     | polymarket_bot.fill_tracker | WS-Reconnect (TimeoutError):  — Reconnect in 1s
```
