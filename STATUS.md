...
## Watchdog
```
STALE — lief vor 99318s | HB: WARNUNG 471s alt
```
...
TimeoutError
2026-05-02 22:59:53 | INFO     | polymarket_bot.fill_tracker | WS-Reconnect (TimeoutError):  — Reconnect in 30s
```
