...
## Watchdog
```
STALE — lief vor 211294s | HB: WARNUNG 472s alt
```
...
TimeoutError
2026-05-04 06:06:08 | INFO     | polymarket_bot.fill_tracker | WS-Reconnect (TimeoutError):  — Reconnect in 30s
```
