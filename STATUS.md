...
## Watchdog
```
STALE — lief vor 6472s | HB: OK (2s alt)
```
...
TimeoutError
2026-05-01 21:25:17 | INFO     | polymarket_bot.fill_tracker | WS-Reconnect (TimeoutError):  — Reconnect in 2s
```
