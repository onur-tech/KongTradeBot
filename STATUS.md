...
## Watchdog
```
STALE — lief vor 202820s | HB: WARNUNG 511s alt
```
...
TimeoutError
2026-05-04 03:44:14 | INFO     | polymarket_bot.fill_tracker | WS-Reconnect (TimeoutError):  — Reconnect in 30s
```
