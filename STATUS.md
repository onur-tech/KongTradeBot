...
## Watchdog
```
STALE — lief vor 32622s | HB: WARNUNG 509s alt
```
...
TimeoutError
2026-05-02 04:27:39 | INFO     | polymarket_bot.fill_tracker | WS-Reconnect (TimeoutError):  — Reconnect in 30s
```
