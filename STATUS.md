...
## Watchdog
```
OK — lief vor 7s | HB: WARNUNG 448s alt
```
...
## Letzte Fehler (3)
```
2026-05-01 10:43:31 | WARNING  | polymarket_bot.execution | [V2] heartbeat failed: PolyApiException[status_code=400, error_message={'heartbeat_id': 'e9dc712d-d303-43a6-9279-99521cbadd02', 'error_msg': 'Invalid Heartbeat ID'}]
[py_clob_client_v2] request error status=400 url=https://clob.polymarket.com/v1/heartbeats body={"heartbeat_id":"f6aec9bc-d1a5-41b2-926f-d5d2d2eeb0b3","error_msg":"Invalid Heartbeat ID"}
2026-05-01 10:43:47 | WARNING  | polymarket_bot.execution | [V2] heartbeat failed: PolyApiException[status_code=400, error_message={'heartbeat_id': 'f6aec9bc-d1a5-41b2-926f-d5d2d2eeb0b3', 'error_msg': 'Invalid Heartbeat ID'}]
```
