...
## Watchdog
```
STALE — lief vor 3614585s | HB: WARNUNG 540s alt
```
...
TimeoutError
2026-06-12 15:26:31 | INFO     | polymarket_bot.fill_tracker | WS-Reconnect (TimeoutError):  — Reconnect in 30s
```
