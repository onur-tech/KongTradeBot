...
## Watchdog
```
STALE — lief vor 124584s | HB: OK (333s alt)
```
...
TimeoutError
2026-05-03 06:03:17 | INFO     | polymarket_bot.fill_tracker | WS-Reconnect (TimeoutError):  — Reconnect in 30s
```
