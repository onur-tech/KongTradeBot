...
## Watchdog
```
STALE — lief vor 111955s | HB: WARNUNG 411s alt
```
...
TimeoutError
2026-05-03 02:31:30 | INFO     | polymarket_bot.fill_tracker | WS-Reconnect (TimeoutError):  — Reconnect in 30s
```
