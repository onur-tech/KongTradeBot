...
## Watchdog
```
STALE — lief vor 50857s | HB: WARNUNG 362s alt
```
...
TimeoutError
2026-05-02 09:34:01 | INFO     | polymarket_bot.fill_tracker | WS-Reconnect (TimeoutError):  — Reconnect in 8s
```
