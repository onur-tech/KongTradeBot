...
## Watchdog
```
STALE — lief vor 134520s | HB: OK (331s alt)
```
...
TimeoutError
2026-05-03 08:48:54 | INFO     | polymarket_bot.fill_tracker | WS-Reconnect (TimeoutError):  — Reconnect in 30s
```
