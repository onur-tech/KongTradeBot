...
## Watchdog
```
STALE — lief vor 116160s | HB: WARNUNG 384s alt
```
...
TimeoutError
2026-05-03 03:42:02 | INFO     | polymarket_bot.fill_tracker | WS-Reconnect (TimeoutError):  — Reconnect in 30s
```
