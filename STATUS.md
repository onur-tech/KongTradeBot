...
## Watchdog
```
STALE — lief vor 102023s | HB: OK (342s alt)
```
...
TimeoutError
2026-05-02 23:47:07 | INFO     | polymarket_bot.fill_tracker | WS-Reconnect (TimeoutError):  — Reconnect in 30s
```
