...
## Watchdog
```
STALE — lief vor 209792s | HB: WARNUNG 392s alt
```
...
TimeoutError
2026-05-04 05:42:25 | INFO     | polymarket_bot.fill_tracker | WS-Reconnect (TimeoutError):  — Reconnect in 30s
```
