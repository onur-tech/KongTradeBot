...
## Watchdog
```
STALE — lief vor 208552s | HB: WARNUNG 572s alt
```
...
TimeoutError
2026-05-04 05:18:45 | INFO     | polymarket_bot.fill_tracker | WS-Reconnect (TimeoutError):  — Reconnect in 30s
```
