...
## Watchdog
```
OK — lief vor 32s | HB: OK (315s alt)
```
...
TimeoutError
2026-04-29 03:45:48 | INFO     | polymarket_bot.fill_tracker | WS-Reconnect (TimeoutError):  — Reconnect in 30s
```
