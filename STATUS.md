...
## Watchdog
```
STALE — lief vor 180159s | HB: WARNUNG 534s alt
```
...
TimeoutError
2026-05-03 21:26:10 | INFO     | polymarket_bot.fill_tracker | WS-Reconnect (TimeoutError):  — Reconnect in 30s
```
