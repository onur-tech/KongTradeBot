...
## Watchdog
```
STALE — lief vor 192831s | HB: WARNUNG 410s alt
```
...
TimeoutError
2026-05-04 00:59:27 | INFO     | polymarket_bot.fill_tracker | WS-Reconnect (TimeoutError):  — Reconnect in 30s
```
