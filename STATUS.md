...
## Watchdog
```
STALE — lief vor 49621s | HB: WARNUNG 543s alt
```
...
TimeoutError
2026-05-02 09:10:23 | INFO     | polymarket_bot.fill_tracker | WS-Reconnect (TimeoutError):  — Reconnect in 4s
```
