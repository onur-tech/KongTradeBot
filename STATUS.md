...
## Watchdog
```
STALE — lief vor 121873s | HB: WARNUNG 447s alt
```
...
TimeoutError
2026-05-03 05:16:12 | INFO     | polymarket_bot.fill_tracker | WS-Reconnect (TimeoutError):  — Reconnect in 30s
```
