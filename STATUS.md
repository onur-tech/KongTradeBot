...
## Watchdog
```
STALE — lief vor 214012s | HB: OK (345s alt)
```
...
TimeoutError
2026-05-04 06:53:34 | INFO     | polymarket_bot.fill_tracker | WS-Reconnect (TimeoutError):  — Reconnect in 30s
```
