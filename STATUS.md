...
## Watchdog
```
OK — lief vor 46s | HB: WARNUNG 394s alt
```
...
2026-04-27 15:28:26 | WARNING  | polymarket_bot.fill_tracker | WebSocket-Fehler: unhandled errors in a TaskGroup (1 sub-exception) — Reconnect in 30s
```
