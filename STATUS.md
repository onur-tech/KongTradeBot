...
## Watchdog
```
STALE — lief vor 152641s | HB: OK (337s alt)
```
...
TimeoutError
2026-05-03 13:50:49 | INFO     | polymarket_bot.fill_tracker | WS-Reconnect (TimeoutError):  — Reconnect in 8s
```
