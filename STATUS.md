...
## Watchdog
```
STALE — lief vor 44176s | HB: OK (16s alt)
```
...
TimeoutError
2026-05-02 07:58:26 | INFO     | polymarket_bot.fill_tracker | WS-Reconnect (TimeoutError):  — Reconnect in 30s
```
