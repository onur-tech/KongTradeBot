...
## Watchdog
```
STALE — lief vor 8617s | HB: WARNUNG 404s alt
```
...
TimeoutError
2026-05-01 21:49:18 | INFO     | polymarket_bot.fill_tracker | WS-Reconnect (TimeoutError):  — Reconnect in 1s
```
