...
## Watchdog
```
STALE — lief vor 3588821s | HB: WARNUNG 552s alt
```
...
TimeoutError
2026-06-12 08:16:55 | INFO     | polymarket_bot.fill_tracker | WS-Reconnect (TimeoutError):  — Reconnect in 8s
```
