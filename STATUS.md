...
## Watchdog
```
STALE — lief vor 175631s | HB: OK (298s alt)
```
...
TimeoutError
2026-05-03 20:14:38 | INFO     | polymarket_bot.fill_tracker | WS-Reconnect (TimeoutError):  — Reconnect in 30s
```
