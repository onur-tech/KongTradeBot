...
## Watchdog
```
STALE — lief vor 58082s | HB: WARNUNG 513s alt
```
...
TimeoutError
2026-05-02 11:31:54 | INFO     | polymarket_bot.fill_tracker | WS-Reconnect (TimeoutError):  — Reconnect in 30s
```
