...
## Watchdog
```
STALE — lief vor 80041s | HB: OK (31s alt)
```
...
TimeoutError
2026-05-02 17:50:56 | INFO     | polymarket_bot.fill_tracker | WS-Reconnect (TimeoutError):  — Reconnect in 30s
```
