...
## Watchdog
```
STALE — lief vor 3620680s | HB: WARNUNG 509s alt
```
...
TimeoutError
2026-06-12 17:08:36 | INFO     | polymarket_bot.fill_tracker | WS-Reconnect (TimeoutError):  — Reconnect in 30s
```
