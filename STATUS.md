...
## Watchdog
```
STALE — lief vor 130312s | HB: WARNUNG 393s alt
```
...
TimeoutError
2026-05-03 07:37:45 | INFO     | polymarket_bot.fill_tracker | WS-Reconnect (TimeoutError):  — Reconnect in 30s
```
