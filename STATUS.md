...
## Watchdog
```
STALE — lief vor 113458s | HB: WARNUNG 506s alt
```
...
TimeoutError
2026-05-03 02:54:57 | INFO     | polymarket_bot.fill_tracker | WS-Reconnect (TimeoutError):  — Reconnect in 30s
```
