...
## Watchdog
```
STALE — lief vor 226736s | HB: OK (184s alt)
```
...
TimeoutError
2026-05-04 10:28:17 | INFO     | polymarket_bot.fill_tracker | WS-Reconnect (TimeoutError):  — Reconnect in 30s
```
