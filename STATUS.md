...
## Watchdog
```
STALE — lief vor 169893s | HB: OK (331s alt)
```
...
TimeoutError
2026-05-03 18:38:28 | INFO     | polymarket_bot.fill_tracker | WS-Reconnect (TimeoutError):  — Reconnect in 30s
```
