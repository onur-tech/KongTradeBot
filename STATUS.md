...
## Watchdog
```
STALE — lief vor 85151s | HB: WARNUNG 549s alt
```
...
TimeoutError
2026-05-02 19:02:27 | INFO     | polymarket_bot.fill_tracker | WS-Reconnect (TimeoutError):  — Reconnect in 30s
```
