...
## Watchdog
```
STALE — lief vor 201319s | HB: WARNUNG 426s alt
```
...
TimeoutError
2026-05-04 03:20:38 | INFO     | polymarket_bot.fill_tracker | WS-Reconnect (TimeoutError):  — Reconnect in 30s
```
