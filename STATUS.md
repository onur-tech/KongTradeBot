...
## Watchdog
```
STALE — lief vor 110445s | HB: OK (303s alt)
```
...
TimeoutError
2026-05-03 02:08:08 | INFO     | polymarket_bot.fill_tracker | WS-Reconnect (TimeoutError):  — Reconnect in 30s
```
