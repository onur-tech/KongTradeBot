...
## Watchdog
```
STALE — lief vor 204021s | HB: OK (295s alt)
```
...
TimeoutError
2026-05-04 04:07:52 | INFO     | polymarket_bot.fill_tracker | WS-Reconnect (TimeoutError):  — Reconnect in 30s
```
