...
## Watchdog
```
STALE — lief vor 215514s | HB: WARNUNG 417s alt
```
...
TimeoutError
2026-05-04 07:17:23 | INFO     | polymarket_bot.fill_tracker | WS-Reconnect (TimeoutError):  — Reconnect in 30s
```
