...
## Watchdog
```
STALE — lief vor 159897s | HB: WARNUNG 412s alt
```
...
TimeoutError
2026-05-03 15:50:31 | INFO     | polymarket_bot.fill_tracker | WS-Reconnect (TimeoutError):  — Reconnect in 30s
```
