...
## Watchdog
```
STALE — lief vor 218524s | HB: WARNUNG 557s alt
```
...
TimeoutError
2026-05-04 08:05:13 | INFO     | polymarket_bot.fill_tracker | WS-Reconnect (TimeoutError):  — Reconnect in 30s
```
